...
export default class BiPspbNotificationSetting extends LightningElement {
  //Proper naming conventions with camel case for all the variable will be followed in the future releases
  //Variable Declaration with
  symptomAll = false;
  PhoneNumber;
  CgNotification = resources.CAREGIVERNOTIFICATION;
  CgNotificationNavigate ;
  ...
  wiredCurrentUser({ error, data }) {
    if (data) {
      ...
      if(data.BI_PSPB_Caregiver__c === false){
...
this.isCheckboxChalEmail = true;
  ...
  openNotificationSettings(){
    let globalThis = window;
    globalThis.location.assign(this.urlq + resources.PATIENT_MYPROFILE_URL);
