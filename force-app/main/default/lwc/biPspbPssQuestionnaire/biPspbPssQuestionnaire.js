...
export default class BiPspbPssQuestionnaire extends LightningElement {
	...
	saveAsDraft() {
		...
		} else if(this.fourthRspValue ==='' && this.fourthResponseText !==''){
