...
import NOTIFIC_SETTING from '@salesforce/label/c.BI_PSPB_TabForNotification';
...
import PROFILE from '@salesforce/label/c.BI_PSP_Profile';
import LABELFORS from '@salesforce/label/c.BI_PSP_LabelForS';
import PATIENT_NOTIFIC from '@salesforce/label/c.BI_PSP_PatientNotification';
import PATIENT_NOTIFICATION from '@salesforce/label/c.BI_PSP_CaregiverPatientSetting';
import MINOR_AGE from '@salesforce/label/c.BI_PSPB_MInorAge';
import MY_NOTIFIC from '@salesforce/label/c.BI_PSP_MyNotification';
import CAREGIVER_NOTIFICATIONS from '@salesforce/label/c.BI_PSPB_CaregiverNotificationUrl';
import NOTIFIC_CENTER from '@salesforce/label/c.BI_PSPB_NotficationCenter';
